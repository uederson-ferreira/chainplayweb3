import { AbstractSigner } from "../../src.ts/providers/index.ts";
import type { SigningKey } from "../../src.ts/crypto/index.ts";
import type { AuthorizationRequest, TypedDataDomain, TypedDataField } from "../../src.ts/hash/index.ts";
import type { Provider, TransactionRequest } from "../../src.ts/providers/index.ts";
import type { Authorization } from "../../src.ts/transaction/index.ts";
/**
