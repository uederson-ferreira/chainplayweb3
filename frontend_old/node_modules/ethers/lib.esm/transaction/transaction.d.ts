import { Signature } from "../../src.ts/crypto/index.ts";
import type { BigNumberish, BytesLike } from "../../src.ts/utils/index.ts";
import type { SignatureLike } from "../../src.ts/crypto/index.ts";
import type { AccessList, AccessListish, Authorization, AuthorizationLike } from "../../src.ts/transaction/index.ts";
/**
