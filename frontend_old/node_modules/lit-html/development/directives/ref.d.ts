 ...
 */
import { ElementPart } from '../../src/lit-html.ts';
import { AsyncDirective } from '../../src/async-directive.ts';
/**
 ...
 * ```
 */
export declare const ref: (_ref?: RefOrCallback<Element> | undefined) => import("../../src/directive.ts").DirectiveResult<typeof RefDirective>;
/**
