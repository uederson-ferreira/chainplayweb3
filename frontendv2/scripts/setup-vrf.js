...
function main() {
  ...
  const VRF_COORDINATOR = process.env.NEXT_PUBLIC_VRF_COORDINATOR || "0x271682DEB8C4E0901D1a1550aD2e64D568E69909";
  const LINK_TOKEN = process.env.NEXT_PUBLIC_LINK_TOKEN || "0x514910771AF9Ca656af840dff83E8264EcF986CA";
